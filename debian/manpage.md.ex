...
ytmusic - program to do something

# SYNOPSIS

**ytmusic** **-e** _this_ [**\-\-example=that**] [{**-e** | **\-\-example**} _this_]
                 [{**-e** | **\-\-example**} {_this_ | _that_}]

**ytmusic** [{**-h** | *\-\-help**} | {**-v** | **\-\-version**}]

# DESCRIPTION

This manual page documents briefly the **ytmusic** and **bar** commands.

This manual page was written for the Debian distribution because the
original program does not have a manual page. Instead, it has documentation
in the GNU info(1) format; see below.

**ytmusic** is a program that...
...
:   The system-wide configuration file to control the behaviour of
    ytmusic. See **foo.conf**(5) for further details.
...
**ytmusic** provides some return codes, that can be used in scripts:
...
Lifantel <Lifantel@unknown>
:   Wrote this manpage for the Debian system.

# COPYRIGHT

Copyright © 2007 Lifantel
